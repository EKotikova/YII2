...
/** @var app\models\SeachPrograms $searchModel */
...
<div class="programs-index">
    ...
    <p>
        ...
        <?= Html::a('Добавить','#',[
            ...
            'data-url' =>Yii::$app->urlManager->createUrl('programs/create'),
            'title'=>Yii::t('yii','Добавить программу'),
            'data-title' => 'Добавление програмы',
            'data-pjax' => '0']); ?>
    </div>
    </p>

    <?php Pjax::begin(['id'=>'programs']); ?>
    <?= GridView::widget([
                ...
                'buttons' => [
                    ...
                    'update'=> function($url,$model,$key){
                        return Html::a('<span class="bi-pencil-fill  pencil"></span>','#',[
                            ...
                            'class' => 'activity-view-link',
                            'data-id' => $key,
                            'data-title' => 'Редактирование программы: ',
                        ]);
                    },
